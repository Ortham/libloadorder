...
extern "C"
{
     ...
     *           passed array. Plugin files are inserted at the end of the load
     *           order, and master files are inserted after the last master
     *           file in the load order. The order of plugin insertion is
     *           undefined besides the distinction made between master files
     *           and plugin files.
     *  @param gh
     *      The game handle the function operates on.
     *  @param plugins
